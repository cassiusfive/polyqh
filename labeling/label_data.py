...
from labeling.spread_calculator import (
...
def extract_orderbook_features(orderbook: Dict) -> Dict:
    ...
    try:
        ...
        # Best bid/ask
        # Bids: highest price is best (should be first if sorted descending)
        # Asks: lowest price is best (need to find minimum if sorted wrong)
...
def extract_trade_features(trades: List[Dict]) -> Dict:
    ...
    try:
        # Use all trades (already limited to 100 from API)
...
def label_market_data(data_file: Path, spread_method: str = "micro_price") -> Dict:
    ...
    Args:
        data_file: Path to scraped JSON file
        spread_method: Method to calculate spread price
    ...
    try:
        ...
        features = {
            ...
            **extract_trade_features(trades),
            "optimal_spread_width": optimal_spread,  # TARGET: what we want to predict
        }
...
def label_all_data(
    ...
    Args:
        ...
        spread_method: Method for calculating spread price
    """
